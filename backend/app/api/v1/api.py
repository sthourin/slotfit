...
api_router.include_router(
    muscle_groups.router, prefix="/muscle-groups", tags=["muscle-groups"]
)
api_router.include_router(equipment.router, prefix="/equipment", tags=["equipment"])
api_router.include_router(
    equipment_profiles.router, prefix="/equipment-profiles", tags=["equipment-profiles"]
)
api_router.include_router(
    slot_templates.router, prefix="/slot-templates", tags=["slot-templates"]
)
api_router.include_router(
    personal_records.router, prefix="/personal-records", tags=["personal-records"]
)
