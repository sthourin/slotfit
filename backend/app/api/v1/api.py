...
from app.api.v1.endpoints import exercises, recommendations, routines, muscle_groups, equipment, equipment_profiles, slot_templates, personal_records, analytics, workouts, injuries, users, patterns
